...
<!-- Sticky wrapper -->
<header
  class="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-border-gray"
>
    ...
    <div class="flex items-center justify-between h-[72px]">
      ...
      >
        <div class="flex flex-col justify-center">
          ...
          >
            <span class="text-slate-900">i</span><span class="text-[#881B1B]"
              >SPARC</span
            >
          </div>
          <span
            class="text-[9px] font-bold text-slate-500 tracking-widest mt-1 uppercase font-sans"
            >IIPS DAVV CELL</span
          >
        </div>
      </a>
