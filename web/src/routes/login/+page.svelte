...
<svelte:head>
	<title>Student Login | iSPARC IIPS DAVV</title>
	<meta
		name="description"
		content="Sign in to your iSPARC account - Institute of Professional Studies (IIPS), Devi Ahilya Vishwavidyalaya, Indore."
	/>
</svelte:head>
