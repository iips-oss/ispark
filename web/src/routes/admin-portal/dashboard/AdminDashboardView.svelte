			...
			<div class="p-2.5 rounded-lg bg-blue-50 text-blue-600 border border-blue-100">
				...
				>
					<path
						stroke-linecap="round"
						stroke-linejoin="round"
						d="M18 21a8 8 0 00-16 0M10 11a4 4 0 100-8 4 4 0 000 8M22 21a6 6 0 00-4.5-5.81M16 3.13a4 4 0 010 7.75"
					/>
				</svg>
			</div>
		</div>
			...
			<div class="p-2.5 rounded-lg bg-purple-50 text-purple-600 border border-purple-100">
				...
				>
					<path
						stroke-linecap="round"
						stroke-linejoin="round"
						d="M6.75 3v2.25M17.25 3v2.25M3.75 9.75h16.5M5.25 4.5h13.5A1.5 1.5 0 0120.25 6v13.5a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5V6a1.5 1.5 0 011.5-1.5zM8.25 13.5h3v3h-3z"
					/>
				</svg>
			</div>
		</div>
